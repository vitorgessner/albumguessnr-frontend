...
const ConfigComponent = ({ inSheet }: { inSheet?: boolean }) => {
                ...
                <Form.Label className="w-full">
                    <div className="flex flex-row items-center justify-between w-full">
                        ...
                        <Switch
                            ...
                            onCheckedChange={() => setConfig({ ...config, tracklist: !config.tracklist })}
                        />
                    </div>
                </Form.Label>
    ...
    return (
        ...
        >
            ...
            >
                <div className="flex flex-col mx-auto pt-3 px-10 gap-3 text-lg bg-(--card-light) lg:bg-(--card-light) border-border">
                    <h2 className="text-2xl">Guessing options</h2>
